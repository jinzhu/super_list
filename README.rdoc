= Super List  - https://github.com/jinzhu/super_list
  ...
  User.new(:gender2 => 'M').gender2                   => "translation missing: en.Gender.M"
  User.new(:gender2 => 'M').gender2(:locale => "api") => "translation missing: api.Gender.M"

  SuperList["Gender"].options                         => {:use_i18n=>true, :i18n_scope=>"Gender", :allow_blank=>true}
